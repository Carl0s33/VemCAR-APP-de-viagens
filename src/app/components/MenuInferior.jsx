...
// 🚀 OTIMIZAÇÃO: Memoizado para não piscar ou recarregar quando o mapa atualiza
      ...
      {tabs.map((tab) => {
        ...
        return (
          <motion.button
            ...
            // 🚀 UX MOBILE: onTap resolve bugs de clique falso em telas sensíveis
          ...
          >
            <div className="menu-icon-container">
              ...
              {/* Pontinho brilhante de indicador ativo */}
              {ativo && (

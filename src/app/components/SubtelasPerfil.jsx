...
// --- 4. SEGURANÇA (O QUE ESTAVA FALTANDO) ---
...
// --- 5. CARONA UNI (ESPECÍFICO IFRN) ---
export const TelaCaronaUni = () => (
  <div className="subtela-container">
    <h2 className="subtela-titulo">Carona Uni</h2>
    <p className="subtela-desc">Status de benefício estudantil para o IFRN.</p>
    
    <div className="card-item-salvo" style={{borderColor: '#00E5FF'}}>
      <GraduationCap size={24} color="#00E5FF" />
      <div style={{ flex: 1 }}>
        <h3 className="titulo-item-salvo">Estudante Validado</h3>
        <p className="desc-item-salvo">Campus Nova Cruz - RN</p>
      </div>

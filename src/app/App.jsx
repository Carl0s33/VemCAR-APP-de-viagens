...
export default function App() {
  // 🚀 ARQUITETURA: Estados centralizados. No futuro, isso aqui vira um Context ou Redux.
  ...
  // 🚀 OTIMIZAÇÃO: useCallback impede que a função de navegar seja recriada à toa
  ...
  return (
      <div style={{ width: "100%", height: "100vh", height: "100dvh", position: "relative", overflow: "hidden", background: isLight ? "#F8FAFC" : "#000000" }}>
        ...
        {/* CONTROLES GLOBAIS (CABECALHO E MENU) */}
        <AnimatePresence>
